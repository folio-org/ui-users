...
const labelIds = {
  ...
  open: LOST_ITEM_STATUSES_TRANSLATIONS_KEYS[LOST_ITEM_STATUSES.OPEN],
  billed: LOST_ITEM_STATUSES_TRANSLATIONS_KEYS[LOST_ITEM_STATUSES.BILLED],
  cancelled: LOST_ITEM_STATUSES_TRANSLATIONS_KEYS[LOST_ITEM_STATUSES.CANCELLED],
  expired: LOST_ITEM_STATUSES_TRANSLATIONS_KEYS[LOST_ITEM_STATUSES.EXPIRED],
};
const initialProps = {
  activeFilters: {},
  onChangeHandlers: {
