        ...
        <Col xs={4}>
          <Row end="xs">
            <Col>
              ...
              <Button id="patron-block-details-modal" istyle={{ 'marginLeft': '15px' }} buttonStyle="primary" to={viewUserPath}><FormattedMessage id="ui-users.blocks.detailsButton" /></Button>
            </Col>
          </Row>
        </Col>
      </Row>
