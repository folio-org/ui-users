...
/* class PermissionsAccordion extends React.Component {
  ...
  constructor(props) {
    ...
    this.isAllowedPermissions = false,
  ...
  render() {
    ...
    this.isAllowedPermissions = !!size;
    console.log('render', this.isAllowedPermissions);
    const message = (
      <FormattedMessage
      ...
      >
        ...
        <IfPermission perm={permToModify}>
          ...
          <Button
            ...
            align="end"
            bottomMargin0
            disabled={!this.isAllowedPermissions}
          ...
          <OnChange name={permissionsField}>
            {() => {
              this.isAllowedPermissions = !!this.getAssignedPermissions().length;
              console.log(this.getAssignedPermissions().length);
            }}
          </OnChange>
        </IfPermission>
...
const PermissionsAccordion = (props) => {
  ...
  const unassignAllPermissions = () => {
    props.form.change(props.permissionsField, []);
    setUnassignModalOpen(false);
