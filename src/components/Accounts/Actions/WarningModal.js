      ...
      >
        ...
        <Row end="xs">
          <Col xs>
            ...
            <Button id="warningTransferContinue" disabled={hasInvalidAccounts || values.length === 0} buttonStyle="primary" onClick={this.onClickContinue}><FormattedMessage id="ui-users.feefines.modal.submit" /></Button>
          </Col>
        </Row>
      </Modal>
    );
