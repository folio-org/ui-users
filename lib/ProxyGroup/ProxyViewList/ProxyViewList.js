...
const ProxyViewList = ({ records, name, label, itemComponent, stripes }) => {
  ...
  const noSponsorsMsg = stripes.intl.formatMessage({ id: 'ui-users.permissions.noSponsorsFound' });
  const noProxiesMsg = stripes.intl.formatMessage({ id: 'ui-users.permissions.noProxiesFound' });
