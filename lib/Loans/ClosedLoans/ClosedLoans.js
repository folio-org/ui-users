...
class ClosedLoans extends React.Component {
  ...
  render() {
    ...
    const visibleColumns = ['title', 'dueDate', 'barcode', 'Call Number', 'Contributors', 'renewals', 'loanDate', 'returnDate', ' '];
    const columnMapping = {
    ...
    return (
      <div>
        ...
        <MultiColumnList
          ...
          columnWidths={{ 'title': 200, 'dueDate': 150, 'barcode': 140, 'Call Number': 110, 'Contributors': 170, 'renewals': 90, 'loanDate': 150, 'returnDate': 150, ' ': 35 }}
