...
class ClosedLoans extends React.Component {
  ...
  getLoansFormatter() {
    return {
      ...
      'checkinLocation': loan => _.get(loan, ['item', 'location', 'name'], ''),
  ...
  render() {
    ...
    const visibleColumns = ['title', 'dueDate', 'barcode', 'Fine', 'Call Number', 'Contributors', 'renewals', 'loanDate', 'returnDate', 'checkinLocation', ' ': 50];
    const columnMapping = {
      ...
      'checkinLocation': this.props.stripes.intl.formatMessage({ id: 'ui-users.loans.columns.checkinLocation' }),
    };
    ...
    return (
      <div>
        ...
        <MultiColumnList
          ...
          columnWidths={{ 'title': 200, 'dueDate': 100, 'barcode': 110, 'Fine': 120, 'Call Number': 110, 'Contributors': 150, 'renewals': 70, 'loanDate': 100, 'returnDate': 100, 'checkinLocation': 140 }}
