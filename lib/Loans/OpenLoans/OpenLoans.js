...
class OpenLoans extends React.Component {
  ...
  constructor(props) {
    ...
    const possibleColumns = ['  ', 'title', 'itemStatus', 'dueDate', 'requests', 'barcode', 'Call number', 'Contributors', 'renewals', 'loanPolicy', 'location', 'loanDate', ' '];
    // list of columns that can be shown/hidden, excludes ellipsis and checkboxes column
    const controllableColumns = ['title', 'itemStatus', 'dueDate', 'requests', 'barcode', 'Call number', 'Contributors', 'renewals', 'loanPolicy', 'location', 'loanDate'];
  ...
  getVisibleColumns() {
    const { possibleColumns, visibleColumns } = this.state;
