...
const ProxyPermissions = (props) => {
  ...
  const isProxyFor = props.stripes.intl.formatMessage({ id: 'ui-users.permissions.isProxyFor', values: { name: fullName } });
  const isSponsorOf = props.stripes.intl.formatMessage({ id: 'ui-users.permissions.isSponsorOf', values: { name: fullName } });
