...
class UserInfo extends React.Component {
  ...
  render() {
    const { user, patronGroup, settings, resources, expanded, accordionId, onToggle, stripes: { intl } } = this.props;
        ...
        <Row>
          <Col xs={hasProfilePicture ? 9 : 12}>
            ...
            <Row>
              ...
              <Col xs={3}>
                <KeyValue label={intl.formatMessage({ id: 'ui-users.information.expirationDate' })} value={formatDate(get(user, ['expirationDate'], ''))} />
              </Col>
              <Col xs={3}>
