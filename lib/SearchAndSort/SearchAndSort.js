...
class SearchAndSort extends React.Component {
  ...
  onSelectRow = this.props.onSelectRow ? this.props.onSelectRow : (e, meta) => {
    ...
    this.log('action', `clicked ${recordId}, selected user =`, meta);
  ...
  render() {
    const { parentResources, stripes, urlQuery, filterConfig, translationBase } = this.props;
    ...
    const searchHeader = (<FilterPaneSearch
      ...
      placeholder={stripes.intl.formatMessage({ id: `${translationBase}.search` })}
    />);
        ...
        <Pane
          ...
          paneTitle={
            <div style={{ textAlign: 'center' }}>
              <strong>Users</strong>
              <div>
                <em>{stripes.intl.formatMessage({ id: `${translationBase}.resultCount` }, { count })}</em>
              </div>
            </div>
          }
          lastMenu={!this.props.disableRecordCreation ? newUserButton : null}
          noOverflow
        >
          <MultiColumnList
            id="list-users"
        ...
        </Layer>
        {
          ...
          <Route
            ...
            render={props => <this.connectedNotes
              ...
              usersResource={this.props.parentResources.records}
              {...props}
            />}
          />
          }
