...
class SearchAndSort extends React.Component {
  static propTypes = {
    viewUserComponent: PropTypes.func.isRequired,
    userFormComponent: PropTypes.func.isRequired,
  ...
  constructor(props) {
    ...
    this.connectedViewUser = props.stripes.connect(props.viewUserComponent);
  ...
  render() {
    const { parentResources, stripes, urlQuery, filterConfig, userFormComponent } = this.props;
