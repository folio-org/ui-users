    ...
    const detailsPane = (
      stripes.hasPerm(viewRecordPerms) ?
        (<Route
          ...
          render={props => <this.connectedViewRecord stripes={stripes} paneWidth="44%" onClose={this.collapseDetails} addressTypes={addressTypes} notesToggle={this.toggleNotes} uniquenessValidator={this.props.parentMutator.uniquenessValidator} {...props} />}
        />) :
        (<div
          style={{
            position: 'absolute',
      ...
      <Paneset>
        ...
        <Layer isOpen={urlQuery.layer ? urlQuery.layer === 'create' : false} label={`Add New ${objectNameUC} Dialog`}>
          <this.props.editRecordComponent
            ...
            uniquenessValidator={this.props.parentMutator.uniquenessValidator}
