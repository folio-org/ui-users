...
class SearchAndSort extends React.Component {
  ...
  render() {
    const { parentResources, stripes, urlQuery, filterConfig, moduleName, newRecordPerms } = this.props;
    ...
    const addRecordHTMLid = `${this.props.objectName}form-add${this.props.objectName}`;
    return (
      <Paneset>
