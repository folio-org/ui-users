...
class SearchAndSort extends React.Component {
  ...
  onNeedMore = () => {
    console.log(`onNeedMore: upgrading userCount from ${this.props.parentResources.userCount} by ${RESULT_COUNT_INCREMENT}`);
  ...
  render() {
    console.log('SearchAndSort: render');
    ...
    console.log('SearchAndSort: users.length =', users.length);
    return (
      <Paneset>
