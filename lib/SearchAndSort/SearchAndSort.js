...
class SearchAndSort extends React.Component {
  ...
  constructor(props) {
    super(props);
    console.log('parentResources.resultCount =', this.props.parentResources.resultCount);
  ...
  render() {
    const { parentResources, stripes, urlQuery, filterConfig, translationBase, newRecordPerms } = this.props;
