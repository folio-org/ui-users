    ...
    const detailsPane = (
      stripes.hasPerm(viewRecordPerms) ?
        (<Route
          ...
          render={props => <this.connectedViewRecord stripes={stripes} paneWidth="44%" onClose={this.collapseDetails} addressTypes={addressTypes} notesToggle={this.toggleNotes} parentMutator={this.props.parentMutator} {...props} />}
        />) :
        (<div
          style={{
            position: 'absolute',
