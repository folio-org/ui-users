  ...
  renderList({ fields }) {
    ...
    return (
      <List
        ...
        isEmptyMessage={this.props.stripes.intl.formatMessage({ id: 'permissions.empty' })}
      />
    );
  }
  ...
  render() {
    ...
    const permsDropdownButton = (
      <IfPermission perm={this.props.permToModify}>
        ...
        >
          <Button align="end" bottomMargin0 data-role="toggle" aria-haspopup="true" id="clickable-add-permission">&#43; <FormattedMessage id="ui-users.permissions.addPermission" /></Button>
          <DropdownMenu
            data-role="menu"
            width="40em"
