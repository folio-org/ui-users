...
const EditUserInfo = ({ parentResources, initialValues, expanded, onToggle, accordionId, stripes: { intl } }) => {
      ...
      <Row>
        <Col xs={8}>
          ...
          <Row>
            ...
            <Col xs={3}>
              <Field label={`${intl.formatMessage({ id: 'ui-users.information.username' })} *`} name="username" id="adduser_username" component={TextField} required fullWidth validStylesEnabled />
            </Col>
          </Row>
        </Col>
      </Row>
