...
* Rename the `ui-users.settings.departments.create.edit.view` permission per naming convention to avoid displaying the edit capability as a view. Fixes UIU-3403.
