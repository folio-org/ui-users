...
* *BREAKING* Migrate custom fields from mod-configuration to mod-settings. Refs UIU-3411.
* *BREAKING* Migrate tags from mod-configuration to mod-settings. Refs UIU-3411.
